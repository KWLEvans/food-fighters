<?php
    ...
    $app->get('/', function() use($app) {
        return $app["twig"]->render("home.html.twig", ['cuisines' => Cuisine::getAll(), 'restaurants' => Restaurant::getAll(), 'user' => $_SESSION['user']]);
    });
    ...
    $app->get("/restaurants/{id}", function($id) use ($app) {
        ...
        return $app['twig']->render('restaurant.html.twig', ['restaurant' => $restaurant, 'reviews' => $reviews]);
    });
